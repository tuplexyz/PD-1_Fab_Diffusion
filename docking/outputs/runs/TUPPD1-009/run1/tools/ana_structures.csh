...
foreach iclu (file.nam)
  ...
  foreach i (`cat $iclu`)
    ...
    head -n100 $i | grep -i energies | sed -e's/\,//g' | awk '{if(NF==15){print $3,$8+$9,$8+0.1*$9,$8,$9,$10,$11,$12,$13,$14,$15} else {print $3,$8+$9,$8+0.1*$9,$8,$9,$10,$11,$12,$13,$14,0.0}}'>>$iclu'_ener'
  end
end
#
# extract violations
...
foreach iclu (file.nam)
  ...
  foreach i (`cat $iclu`)
    ...
    head -n100 $i | grep -i " violation" | sed -e's/\,//g' | awk '{if (NF==8){print $3,$4,$5,$6,$7,$8} else {print $3,$4,$5,$6,$7,0}}'>>$iclu'_viol'
  end
end
#
